...
**Build:** `docker build -t ekdp-api ./backend`
...
| `AUTO_MIGRATE` | `false` |
| `TRUST_PROXY` | `true` |
| `CORS_ORIGINS` | the frontend's deployed origin, e.g. `https://ekdp.vercel.app` |
...
| Var | Value |
| --- | --- |
| `API_PROXY_TARGET` | the backend's public URL, e.g. `https://ekdp-api.onrender.com` |
